<template>
    <div class="center">
        <h2> <font-awesome-icon icon="user" /> Account Registration</h2>
        <form @submit.prevent="handleRegister">
            ...
            <div class="form-group">
                <router-link to="/login"><div style="display:inline-block" class="btn large main success negative">Login</div></router-link>
